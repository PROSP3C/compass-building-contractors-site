    ...
    >
      <div>
        <q-toolbar>
          ...
          <div class="MainLayout-desktopContactInfo">
            <div>
              <a
          ...
          <q-btn
            class="MainLayout-mobileMenuButton"
            dense
            flat
            round
            icon="menu"
